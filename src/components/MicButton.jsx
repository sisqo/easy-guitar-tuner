export default function MicButton({ listening, onStart, onStop }) {
  return (
    <button
      ...
      className={`
        group relative w-16 h-16 rounded-full flex items-center justify-center shrink-0
    ...
    >
      ...
      <svg xmlns="http://www.w3.org/2000/svg"
        className={`relative w-7 h-7 transition-colors ${listening ? 'text-white' : 'text-zinc-500 dark:text-zinc-300'}`}
