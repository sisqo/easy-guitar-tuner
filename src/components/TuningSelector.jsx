  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        className="bg-zinc-800 dark:bg-zinc-900 text-zinc-100 rounded-lg px-3 py-2 border border-zinc-700 focus:outline-none focus:border-zinc-500 cursor-pointer"
        style={{ fontSize: '16px' }}
      >
